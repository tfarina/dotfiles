...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-delimiter-face ((,class (:foreground "#008000"))))
   `(font-lock-comment-face ((,class (:foreground "#008000"))))
   `(font-lock-constant-face ((,class (:foreground "#0000FF"))))
   `(font-lock-doc-face ((,class (:foreground "#008000"))))
   `(font-lock-function-name-face ((,class (:weight normal :foreground "#000000"))))
   `(font-lock-keyword-face ((,class (:bold nil :foreground "#0000FF"))))
   `(font-lock-preprocessor-face ((,class (:foreground "#0000FF"))))
   ...
   `(font-lock-string-face ((,class ,:foreground "#A31515")))
   `(font-lock-type-face ((,class (:weight normal :foreground "#2B91AF"))))
   `(font-lock-variable-name-face ((,class (:weight normal :foreground "#000000"))))
